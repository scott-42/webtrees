				...
				<tr>
					...
					<td class="optionbox">
						...
						<label>
							...
							<?= I18N::translate('Month of marriage') ?>
						</label>
						<br>
						<label>
							...
							<?= I18N::translate('Month of first marriage') ?>
						</label>
						<br>
						<label>
							...
							<?= I18N::translate('Month of birth of first child in a relation') ?>
						</label>
						<br>
						<label>
						...
						<label>
							...
							<?= I18N::translate('Age in year of first marriage') ?>
						</label>
						<br>
						<label>
						...
						<label>
							...
							<?= I18N::translate('Individual distribution') ?>
						</label>
						<br>
						<label>
							...
							<?= I18N::translate('Birth by country') ?>
						</label>
						<br>
						<label>
							...
							<?= I18N::translate('Marriage by country') ?>
						</label>
						<br>
						<label>
							...
							<?= I18N::translate('Death by country') ?>
						</label>
						<br>
						<br>
