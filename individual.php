...
// All tabs to insert Javascript, etc.
	...
	<div class="col-sm-8">
				...
				<div class="card">
					<div class="card-header" role="tab" id="name-header-add">
						<div class="card-title mb-0">
							<a data-toggle="collapse" data-parent="#individual-names" href="#name-content-add" aria-expanded="false" aria-controls="name-content-add">
								<?= I18N::translate('Add a name') ?>
							</a>
						</div>
					</div>
					<div id="name-content-add" class="collapse" role="tabpanel" aria-labelledby="name-header-add">
		...
		<div id="individual-tabs">
			...
			<div class="tab-content">
				<?php	foreach (array_values($controller->getTabs()) as $n => $tab): ?>
					<div id="<?= $tab->getName() ?>" class="tab-pane fade wt-ajax-load" role="tabpanel"><?php if ($n === 0 || !$tab->canLoadAjax()): ?><?= $tab->getTabContent() ?><?php endif ?></div>
				<?php endforeach ?>
			</div>
		</div>
	</div>
