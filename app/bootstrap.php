...
define('WT_BOOTSTRAP_CSS_URL', WT_STATIC_URL . 'packages/bootstrap-4.0.0-alpha6/bootstrap.min.css');
...
define('WT_BOOTSTRAP_JS_URL', WT_STATIC_URL . 'packages/bootstrap-4.0.0-alpha6/bootstrap.min.js');
define('WT_BOOTSTRAP_RTL_CSS_URL', WT_STATIC_URL . 'packages/bootstrap-rtl-3.3.4/css/bootstrap-rtl.min.css');
define('WT_DATATABLES_JS_URL', WT_STATIC_URL . 'packages/datatables-1.10.13/jquery.dataTables.min.js');
define('WT_DATATABLES_BOOTSTRAP_CSS_URL', WT_STATIC_URL . 'packages/datatables-1.10.13/dataTables.bootstrap4.min.css');
define('WT_DATATABLES_BOOTSTRAP_JS_URL', WT_STATIC_URL . 'packages/datatables-1.10.13/dataTables.bootstrap4.min.js');
...
define('WT_JQUERY_COLORBOX_URL', WT_STATIC_URL . 'assets/js-1.8.0/jquery.colorbox-1.5.14.js');
define('WT_JQUERY_WHEELZOOM_URL', WT_STATIC_URL . 'assets/js-1.8.0/jquery.wheelzoom-2.0.0.js');
define('WT_CKEDITOR_BASE_URL', WT_STATIC_URL . 'packages/ckeditor-4.5.2-custom/');

// Location of our own scripts
define('WT_ADMIN_JS_URL', WT_STATIC_URL . 'assets/js-1.8.0/admin.js');
define('WT_WEBTREES_JS_URL', WT_STATIC_URL . 'assets/js-1.8.0/webtrees.js');
define('WT_FONT_AWESOME_RTL_CSS_URL', WT_STATIC_URL . 'assets/js-1.8.0/font-awesome-rtl.css');
