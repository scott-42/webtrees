...
class HtmlBlockModule extends AbstractModule implements ModuleBlockInterface {
	...
	public function getBlock($block_id, $template = true, $cfg = []) {
		...
		*/
		...
		if ($ctype === 'gedcom' && Auth::isManager($WT_TREE) || $ctype === 'user' && Auth::check()) {
			$title = '<a class="icon-admin" href="block_edit.php?block_id=' . $block_id . '&amp;ged=' . $WT_TREE->getNameHtml() . '&amp;ctype=' . $ctype . '">' . I18N::translate('Preferences') . '</a> ' . $title;
		}
	...
	public function configureBlock($block_id) {
		...
		<div class="row form-group">
			<label class="col-sm-3 form-control-label" for="title">
		...
		<div class="row form-group">
			<label class="col-sm-3 form-control-label" for="template">
		...
		<div class="row form-group">
			<label class="col-sm-3 form-control-label" for="gedcom">
		...
		<div class="row form-group">
			<label class="col-sm-3 form-control-label" for="html">
		...
		<fieldset class="row form-group">
			<legend class="col-sm-3 form-control-legend">
