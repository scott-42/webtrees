...
case 'privacy':
	$controller
		...
		->addInlineJavascript('
			$("#default-resn input[type=checkbox]").on("click", function() {
...
<form class="form-horizontal" method="post">
	...
	<div class="row form-group">
		...
		<div class="col-sm-8">
			<?= Bootstrap4::select(['0' => I18N::translate('Show to visitors'), '1' => I18N::translate('Show to members')], $WT_TREE->getPreference('REQUIRE_AUTHENTICATION'), ['id' => 'REQUIRE_AUTHENTICATION', 'name' => 'REQUIRE_AUTHENTICATION']) ?>
	...
	<div class="row form-group">
		...
		<div class="col-sm-8">
			<?= Bootstrap4::select(array_slice(FunctionsEdit::optionsAccessLevels(), 0, 2, true), $WT_TREE->getPreference('SHOW_DEAD_PEOPLE'), ['id' => 'SHOW_DEAD_PEOPLE', 'name' => 'SHOW_DEAD_PEOPLE']) ?>
			<p class="small text-muted">
	...
	<fieldset class="row form-group">
		...
		<div class="col-sm-8">
			<?= Bootstrap4::select(['0' => I18N::translate('Show to visitors'), '1' => I18N::translate('Show to members')], $WT_TREE->getPreference('HIDE_LIVE_PEOPLE'), ['id' => 'HIDE_LIVE_PEOPLE', 'name' => 'HIDE_LIVE_PEOPLE']) ?>
			<p class="small text-muted">
	...
	<div class="row form-group">
		...
		<div class="col-sm-8">
			<?= Bootstrap4::select(array_slice(FunctionsEdit::optionsAccessLevels(), 0, 3, true), $WT_TREE->getPreference('SHOW_LIVING_NAMES'), ['id' => 'SHOW_LIVING_NAMES', 'name' => 'SHOW_LIVING_NAMES']) ?>
			<p class="small text-muted">
	...
	<div class="row form-group">
		...
		<div class="col-sm-8">
			<?= Bootstrap4::select(['0' => I18N::translate('Hide from everyone'), '1' => I18N::translate('Show to visitors')], $WT_TREE->getPreference('SHOW_PRIVATE_RELATIONSHIPS'), ['id' => 'SHOW_PRIVATE_RELATIONSHIPS', 'name' => 'SHOW_PRIVATE_RELATIONSHIPS']) ?>
			<p class="small text-muted">
	...
	<table class="table table-bordered table-condensed table-hover" id="default-resn">
		...
		<?php foreach ($resns as $resn): ?>
			<tr>
				<td>
					<?php if ($resn->record): ?>
					<a href="<?= $resn->record->getHtmlUrl() ?>"><?= $resn->record->getFullName() ?></a>
				...
				<td>
					<?= FunctionsEdit::optionsRestrictions(false)[$resn->resn] ?>
				</td>
				<td>
					<label for="delete-<?= $resn->default_resn_id ?>">
						<input id="delete-<?= $resn->default_resn_id ?>" name="delete[]" type="checkbox" value="<?= $resn->default_resn_id ?>">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= $WT_TREE->getPreference('PEDIGREE_ROOT_ID') ?>"
				>
	...
	<!-- CALENDAR_FORMAT -->
	<fieldset class="row form-group form-inline">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="INDI_FACTS_ADD"
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('INDI_FACTS_ADD')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('INDI_FACTS_UNIQUE')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('QUICK_REQUIRED_FACTS')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('INDI_FACTS_QUICK')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="FAM_FACTS_ADD"
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('FAM_FACTS_ADD')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('FAM_FACTS_UNIQUE')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('QUICK_REQUIRED_FAMFACTS')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('FAM_FACTS_QUICK')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="SOUR_FACTS_ADD"
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('SOUR_FACTS_ADD')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('SOUR_FACTS_UNIQUE')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('SOUR_FACTS_QUICK')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="REPO_FACTS_ADD"
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('REPO_FACTS_ADD')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('REPO_FACTS_UNIQUE')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('REPO_FACTS_QUICK')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('ADVANCED_NAME_FACTS')) ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?= Filter::escapeHtml($WT_TREE->getPreference('ADVANCED_PLAC_FACTS')) ?>"
					>
				<div class="input-group-btn">
